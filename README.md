...
- [SharpMod.PlayerGUI](https://github.com/morphx666/SharpMod/blob/master/SharpMod.PlayerGUI/README.md) — cross-platform desktop GUI ([Eto.Forms](https://github.com/picoe/Eto))
- [SharpMod.ConsolePlayer](https://github.com/morphx666/SharpMod/blob/master/SharpMod.ConsolePlayer/README.md) — cross-platform terminal player ([PrettyConsole](https://github.com/dusrdev/PrettyConsole))
- [SharpMod.Wasm](https://github.com/morphx666/SharpMod/blob/master/SharpMod.Wasm/README.md) — browser player running as a WebAssembly module ([live sample](https://sharpmod.djxavi.com/))
